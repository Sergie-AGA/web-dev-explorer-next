...
export async function generateMetadata(slug: IProductProps) {
    ...
    const product = products.find(product => product.slug === slug.params.product);
  ...
  return (
    <main className="max-width-container py-4">
        ...
        <section>
            {
            product ? 
                <ProductDetail product={product} discountedPrice={discountedPrice || 0} pickUpPrice={pickUpPrice || 0} />
