...
export default function MorphingCard({ data }: CardProps) {
  ...
  return (
    <>
      <li className="min-w-[250px] min-h-[250px] w-[100%] md:w-[20%] aspect-square rounded-def bg-cyan-700 relative overflow-hidden bg-cover bg-center cursor-pointer morphing-card m-auto rounded">
        <img
          src={imageUrl}
          alt="Project image"
